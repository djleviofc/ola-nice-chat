...
serve(async (req) => {
  ...
  try {
    ...
    const preference = {
      ...
      back_urls: {
        success: "https://momentodeamor.com.br/pagamento-sucesso",
        failure: "https://momentodeamor.com.br/criar?status=failure",
        pending: "https://momentodeamor.com.br/criar?status=pending",
      },
