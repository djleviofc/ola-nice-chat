    ...
    <div className="relative bg-background min-h-screen">
      ...
      {page.musica_url && (
        <section className="relative py-24 px-4 flex flex-col items-center">
          ...
          <SpotifyPlayer songName="Nossa Música" artistName={coupleNames} coverPhoto={photos.length > 0 ? photos[0].src : undefined} musicUrl={page.musica_url || undefined} onPlayTriggered={handlePlayTriggered} />
